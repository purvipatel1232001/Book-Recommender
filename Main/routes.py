...
from Main.recomm import recom, bookdisp, pointwise_rank
...
posts = [
	{
	'author' : 'Team03',
	'title' : 'Recommendation System Assignment'
	}
]
...
def recommender():
	form=BookForm()
	df=pd.read_csv("C:\\Users\\purvi\\Desktop\\Book\\Book-Recommendation-System\\Bookz.csv")
	if form.validate_on_submit():
...
def uploadbook():
	...
	if form.validate_on_submit():
		...
		upload('C:\\Users\\purvi\\Desktop\\Book\\Book-Recommendation-System\\Bookz.csv',li)
...
def deletebook():
	form=DeleteBook()
	if form.validate_on_submit():
		delete(form.ISBN.data,'C:\\Users\\purvi\\Desktop\\Book\\Book-Recommendation-System\\Bookz.csv')
